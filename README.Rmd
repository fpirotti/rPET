...
a faster way in vectorized format, like
running each row from table below:
...
All possible combinations of three values from three factors for a total of 
27 combinations.
...
::: {#euimgdiv}
This work is part of the (VARCITIES project)[https://www.varcities.eu], that has received funding from the European Union's Horizon 2020
