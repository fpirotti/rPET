---
title: rPET - Physiological Equivalent Temperature
editor_options: 
  markdown: 
    wrap: 72
output: 
...
[![CRAN status](https://www.r-pkg.org/badges/version/rPET)](https://CRAN.R-project.org/package=rPET)
...
Plotting combinations of 10 values from two factors,
...
If you have a Digital Terrain Model and a point cloud 3D model in LAS format,
then you can simulate and map PET over the DTM grid values.

<label>Below an animation of mapped comfort index changing over a hot summer day in 
Villa Bolasco [VARCITIES project - grant agreement n. ](https://www.varcities.eu/){target=_blank}</label>
<img src="man/figures/gif_filePMV.gif" />
...
Pirotti F, Piragnolo M, D’Agostini M, Cavalli R. 
Information Technologies for Real-Time Mapping of Human Well-Being Indicators 
in an Urban Historical Garden. *Future Internet*. 2022; 14(10):280. [https://doi.org/10.3390/fi14100280](https://doi.org/10.3390/fi14100280)
...
Pages 1-10,
ISSN 0360-1323,
[https://doi.org/10.1016/j.buildenv.2018.03.054](https://doi.org/10.1016/j.buildenv.2018.03.054).

For a nice overview of the meaning of PET see also: 

Höppe, P. The physiological equivalent temperature – a universal index for the biometeorological assessment of the thermal environment. Int J Biometeorol 43, 71–75 (1999). [https://doi.org/10.1007/s004840050118](https://doi.org/10.1007/s004840050118)


RayShader function for mapping estimated solar radiation values was taken 
partly from the work of
[tylermorganwal's rayshader for
R](https://github.com/tylermorganwall/rayshader){target="\_blank"} 
and  adapted to point clouds. For more detail on point clouds see 
[Pirotti et al., 2022](https://doi.org/10.3390/fi14100280)
...
<div style="width: *; float:left; height:100px; font-size:smaller; margin:5px; padding-left: 5px;">
...
<br>This  page reflect only the authors’ view and the European Commission/EASME  is not responsible for any use that may be made of the information  it contains.
</div>
</div>
