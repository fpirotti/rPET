...
The goal of rPET is to calculate Physiological Equivalent Temperature (PET) adapted from
...
You can install the released version of rPET from [CRAN](https://CRAN.R-project.org) with:
